...
public class MemberTest {
    ...
    @Test
    public void MemberTestSuccessfulCreation(){
    ...
    @Test
    public void MemberTestSuccessfulMemberCreationInDatabase(){
        Member emptyMember = new Member("TestDBFirst","TestDBLast","TestDBDob","TestDBEmail",11111111, false);

        emptyMember.addUser();

        assertTrue("Member.isMember should be true if created successfully", emptyMember.getIsMember());
    }
